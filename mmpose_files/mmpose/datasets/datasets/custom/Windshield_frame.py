...
@DATASETS.register_module(name="WindshieldFrame")
class WindshieldFrame(Kpt2dSviewRgbImgTopDownDataset):
    """CocoWindshield for Windshield corner detetcion.


    The dataset loads raw features and apply specified transforms
    to return a dict containing the image tensors and other information.

    The windshield corner annotations follow the 68 points mark-up.
    ...
    def __init__(
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile("configs/_base_/datasets/custom_windshield.py")
    ...
    def _get_db(self):
        ...
        for img_id in self.img_ids:
            ...
            for obj in objs:
                ...
                print("11111: %%%%%%%%%", keypoints)

                print("22222: %%%%%%%%%", joints_3d)

                print("33333: %%%%%%%%%", joints_3d_visible)
